...
<template>
  ...
  >
    ...
    >
      <div
        class="flex items-start flex-col md:flex-row gap-[1.2rem] relative z-2"
      >
        <div
          class="p-[1.6rem] md:p-[2.4rem] bg-[--base] rounded-[0.4rem] w-full text-[--accent] flex flex-col gap-[1.6rem]"
        >
          <h1
            class="text-[3.2rem]/[90%] md:text-[5.6rem]/[90%] font-medium tracking-[-4%]"
          >
        ...
        <div class="flex flex-wrap justify-end gap-[1.2rem] w-full">
          <Bullet v-for="item in items">
            {{ item.text }}
          </Bullet>
        </div>
      </div>
      <NuxtImg
        src="/images/dog.webp"
        alt="Собака"
        class="absolute w-[27rem] min-[380px]:w-full min-[390px]:w-[27rem] min-[767px]:w-[60rem] min-[979px]:w-[40rem] min-[1280px]:w-[50rem] min-[1380px]:w-[40rem] h-auto bottom-[-5rem] z-0 md:bottom-[-10rem] left-1/2 -translate-x-1/2"
      />
